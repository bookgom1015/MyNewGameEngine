...
constexpr CD3DX12_GPU_DESCRIPTOR_HANDLE Render::DX::Shading::ToneMapping::ToneMappingClass::InterMediateMapSrv() const { 
	return mhIntermediateMapGpuSrv; 
}

constexpr CD3DX12_CPU_DESCRIPTOR_HANDLE Render::DX::Shading::ToneMapping::ToneMappingClass::InterMediateMapRtv() const { 
...
constexpr CD3DX12_GPU_DESCRIPTOR_HANDLE Render::DX::Shading::ToneMapping::ToneMappingClass::InterMediateCopyMapSrv() const {
