...
//		b.Bottom = min3(b.Bottom, g_vertices[triangle.Index1]);  // index of vertex
//		b.Bottom = min3(b.Bottom, g_vertices[triangle.Index2]);
//		b.Bottom = min3(b.Bottom, g_vertices[triangle.Index3]);
//
//		// loop over triangle vertices and pick largest vertex for top of triangle bbox
//		b.Top = max3(b.Top, g_vertices[triangle.Index1]);
//		b.Top = max3(b.Top, g_vertices[triangle.Index2]);
//		b.Top = max3(b.Top, g_vertices[triangle.Index3]);
//
